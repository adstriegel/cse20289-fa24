...
def parsefile_tpc(filename, CreateCSV=False):
    ...
    print('TPC Members - Fully Confirmated:  ' + str(CountAllConfirmed) + ' (' + fancyFloatPct(CountAllConfirmed, CountTPC) + '%)')
...
parser.add_argument('--csv', type=bool, help='Output result as CSV', default=False)
...
if args.mode == 'tpc':
    parsefile_tpc(args.dir + '/' + args.file)
